...
class BondsListView(generics.ListAPIView):
    ...
    ordering_fields = ['tenure_days', 'ytm_percent'] 
    pagination_class = BondCursorPagination  
...
class BondDetailView(APIView):
    ...
    def get(self, request):
        ...
        data = {
            ...
            "company": ISINCompanyMapSerializer(company_map).data if company_map else None,
            "rta": ISINRTAMapSerializer(rta_map).data if rta_map else None,
        }
